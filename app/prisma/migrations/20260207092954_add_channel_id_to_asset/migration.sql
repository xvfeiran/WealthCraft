...
INSERT INTO "new_Asset" ("allocationPercent", "contributionAmount", "costPrice", "createdAt", "currency", "currentPrice", "id", "market", "name", "portfolioId", "quantity", "source", "subPortfolioId", "symbol", "updatedAt") SELECT "allocationPercent", "contributionAmount", "costPrice", "createdAt", "currency", "currentPrice", "id", "market", "name", "portfolioId", "quantity", "source", "subPortfolioId", "symbol", "updatedAt" FROM "Asset";
DROP TABLE "Asset";
