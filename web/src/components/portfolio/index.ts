 ...
 *
 * This directory contains all modal and form components for portfolio management.
 * Each component is in its own file to follow the Single Responsibility Principle.
 */
